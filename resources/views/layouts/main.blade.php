                    ...
                    <div class="card-body d-flex justify-content-between align-items-center"
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="dropdown" style="margin-right: 10px; position: relative;">
                                <i class="bi bi-bell" id="notifDropdown" data-bs-toggle="dropdown" aria-expanded="false"
                                    style="font-size: 20px; position: relative;">
                                    @php
                                        $unreadCount = \App\Models\Announcement::where('user_id', auth()->id())
                                            ->where('is_read', false)
                                            ->count();
                                    @endphp
                                    @if ($unreadCount > 0)
                            ...
                            <div class="dropdown">
                                <!-- Profile Image -->
                                <img src="https://www.pngall.com/wp-content/uploads/5/User-Profile-PNG-Image.png"
                                    alt="Profile" class="profile-img" id="profileDropdown" data-bs-toggle="dropdown"
                                    aria-expanded="false" width="50">
